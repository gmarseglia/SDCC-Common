...
const (
	Front_ConvolutionalLayer_FullMethodName = "/proto.Front/ConvolutionalLayer"
)
...
func (c *frontClient) ConvolutionalLayer(ctx context.Context, in *ConvolutionalLayerFrontRequest, opts ...grpc.CallOption) (*ConvolutionalLayerFrontReply, error) {
	...
	err := c.cc.Invoke(ctx, Front_ConvolutionalLayer_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
const (
	Back_Cancel_FullMethodName             = "/proto.Back/Cancel"
	Back_ConvolutionalLayer_FullMethodName = "/proto.Back/ConvolutionalLayer"
)
...
func (c *backClient) Cancel(ctx context.Context, in *CancelRequest, opts ...grpc.CallOption) (*CancelReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CancelReply)
	err := c.cc.Invoke(ctx, Back_Cancel_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *backClient) ConvolutionalLayer(ctx context.Context, in *ConvolutionalLayerBackRequest, opts ...grpc.CallOption) (*ConvolutionalLayerBackReply, error) {
	...
	err := c.cc.Invoke(ctx, Back_ConvolutionalLayer_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
const (
	Master_NotifyPing_FullMethodName = "/proto.Master/NotifyPing"
)
...
func (c *masterClient) NotifyPing(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PingReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PingReply)
	err := c.cc.Invoke(ctx, Master_NotifyPing_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
